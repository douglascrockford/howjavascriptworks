...
/*property
    ...
    integer_, isArray, isFrozen, isSafeInteger, is_big_float, keys, le, length,
    lt, make, map, mask, max, min, mul, ne, neg, normalize, not, number,
    number_, or, push, record, record_, reduce, resolve, set, shift_down,
    shift_up, slice, split, string, sub, ternary, text, text_, wun, xor
*/
